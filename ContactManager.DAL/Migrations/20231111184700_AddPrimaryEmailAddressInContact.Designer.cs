...
namespace ContactManager.DAL.Migrations
{
    ...
    [Migration("20231111184700_AddPrimaryEmailAddressInContact")]
    partial class AddPrimaryEmailAddressInContact
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContactManager.DAL.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ContactManager.DAL.Contact", b =>
                {
                    ...
                    b.HasIndex("PrimaryEmailAddressId")
                        .IsUnique()
                        .HasFilter("[PrimaryEmailAddressId] IS NOT NULL");
